      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="p-6 border-t border-cocoa-100 dark:border-cocoa-800 bg-white/50 dark:bg-cocoa-900/50">
              ...
              <button className="w-full py-4 bg-cocoa-900 text-white rounded-xl font-medium shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all disabled:opacity-50 disabled:cursor-not-allowed" disabled={items.length === 0}>
                Checkout
              </button>
            </div>
          </motion.div>
